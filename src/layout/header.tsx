  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-teal p-6">
      ...
      <div className="block lg:hidden">
        <button onClick={() => setCollapse(!isCollapse)} className="flex items-center px-3 py-2 border rounded text-teal-lighter border-teal-light hover:text-white hover:border-white">
